  ...
  $.dlxQuiz = function ( element, options ) {
    var plugin = this,
      ...
      defaults = {
        ...
        /* Text
         ---------------------------*/
        questionCount_text: "Q %current_index of %totalQuestions",
        ...
        quizScoreRank_text: {
          a: "Are you Satoshi??",
          b: "You are a Satoshi expert!",
          c: "Welcome to the Satoshi fan club.",
          d: "Scroll down and read through all the information plz",
          f: "..."
        },
    ...
    plugin.method = {
      buildQuiz: function ( data ) {
        ...
        $.each( questions, function ( q ) {
          ...
          //question title
          _quizHTML += '<div class="' + class_questionTitle + '">';
      ...
      buildQuizResults: function () {
        ...
        //quiz score rank
        resultsHTML += '<div class="' + class_quizScoreRank + '">';
        if ( totalScore > 80 ) {
          //rank 1: 80-100
    ...
    plugin.events = {
      ...
      resultsButton: function () {
        $( _quizViewResultsButton ).on( 'click', function () {
          ...
          //build results
          resultsHTML = '<div class="hidden">' + plugin.config.resultsHeader_text + '</div>';
          ...
          $.each( questions, function ( index ) {
            ...
            //question
            resultsHTML += '<div class="questionTitle">';
